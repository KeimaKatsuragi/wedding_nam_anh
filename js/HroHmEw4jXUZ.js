...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [1476], {
    69260: function(e, t, n) {
      ! function(e, t, n) {
        ...
        var c = ["animationData", "loop", "autoplay", "initialSegment", "onComplete", "onLoopComplete", "onEnterFrame", "onSegmentStart", "onConfigReady", "onDataReady", "onDataFailed", "onLoadedImages", "onDOMLoaded", "onDestroy", "lottieRef", "renderer", "name", "assetsPath", "rendererSettings"],
          p = function(e, t) {
            ...
            var O = l(e, c),
              ...
              T = function() {
                ...
                if (L.current) {
                  ...
                  return D.current = o.default.loadAnimation(r), R(!!D.current),
                    function() {
                      var e;
                      null === (e = D.current) || void 0 === e || e.destroy(), D.current = void 0
                    }
                }
              };
            return n.useEffect(function() {
              ...
              if (D.current) {
                ...
                Array.isArray(d) && d.length && ((D.current.currentRawFrame < d[0] || D.current.currentRawFrame > d[1]) && (D.current.currentRawFrame = d[0]), D.current.setSegment(d[0], d[1]))
              }
              ...
              if (e.length) {
                var t = e.map(function(e) {
                  var t;
                  return null === (t = D.current) || void 0 === t || t.addEventListener(e.name, e.handler),
                    function() {
                      var t;
                      null === (t = D.current) || void 0 === t || t.removeEventListener(e.name, e.handler)
                    }
                });
                return function() {
              ...
              goToAndStop: function(e, t) {
                var n;
                null === (n = D.current) || void 0 === n || n.goToAndStop(e, t)
              },
              goToAndPlay: function(e, t) {
                var n;
                null === (n = D.current) || void 0 === n || n.goToAndPlay(e, t)
              },
              ...
              playSegments: function(e, t) {
                var n;
                null === (n = D.current) || void 0 === n || n.playSegments(e, t)
              },
              ...
              getDuration: function(e) {
                var t;
                return null === (t = D.current) || void 0 === t ? void 0 : t.getDuration(e)
              },
              destroy: function() {
                var e;
                null === (e = D.current) || void 0 === e || e.destroy(), D.current = void 0
          ...
          f = function(e) {
            ...
            n.useEffect(function() {
              var e, n, a, s, u, l = t.current;
              if (l && r && i.length) switch (r.stop(), o) {
                case "scroll":
                  return e = null, n = function() {
                      var t, n, o, a = (n = (t = l.getBoundingClientRect()).top, o = t.height, (window.innerHeight - n) / (window.innerHeight + o)),
                        s = i.find(function(e) {
                          var t = e.visibility;
                      ...
                      if (s) {
                        if ("seek" === s.type && s.visibility && 2 === s.frames.length) {
                          var u = s.frames[0] + Math.ceil((a - s.visibility[0]) / (s.visibility[1] - s.visibility[0]) * s.frames[1]); //! goToAndStop must be relative to the start of the current segment
                ...
                case "cursor":
                  return a = function(e, t) {
                      var n = e,
                        o = t;
                      if (-1 !== n && -1 !== o) {
                        var a, s, u, c, p, f = (a = n, s = o, c = (u = l.getBoundingClientRect()).top, p = u.left, {
                          x: (a - p) / u.width,
                          y: (s - c) / u.height
                        });
                        n = f.x, o = f.y
                      ...
                      if (d) {
                        if ("seek" === d.type && d.position && Array.isArray(d.position.x) && Array.isArray(d.position.y) && 2 === d.frames.length) {
                          var m = (n - d.position.x[0]) / (d.position.x[1] - d.position.x[0]),
                            v = (o - d.position.y[0]) / (d.position.y[1] - d.position.y[0]);
                          r.playSegments(d.frames, !0), r.goToAndStop(Math.ceil((m + v) / 2 * (d.frames[1] - d.frames[0])), !0)
                        }
                      ...
                      a(-1, -1)
                    }, l.addEventListener("mousemove", s), l.addEventListener("mouseout", u),
                    function() {
                      l.removeEventListener("mousemove", s), l.removeEventListener("mouseout", u)
                    }
              }
            }, [o, r])
          },
        ...
        Object.defineProperty(e, "LottiePlayer", {
          ...
          }, [null === (t = e.lottieRef) || void 0 === t ? void 0 : t.current]), d({
            lottieObj: {
              View: u,
              play: c,
              stop: f,
        ...
        }, e.useLottie = p, e.useLottieInteractivity = d, Object.defineProperty(e, "__esModule", {
          value: !0
        })
      }(t, n(11248), n(67294))
    },
    79281: function(e, t, n) {
      ...
      function a(e, t) {
        e.prototype = Object.create(t.prototype), e.prototype.constructor = e, (0, i.Z)(e, t)
      }
      ...
      var u = n(67294),
        ...
        g = function(e) {
          function t(t, n) {
            ...
            return r.appearStatus = null, t.in ? i ? (o = m, r.appearStatus = v) : o = y : o = t.unmountOnExit || t.mountOnEnter ? d : m, r.state = {
              status: o
          ...
          return n.componentDidMount = function() {
            ...
            if (e !== this.props) {
              ...
              this.props.in ? n !== v && n !== y && (t = v) : (n === v || n === y) && (t = h)
            }
      ...
      g.contextType = p, g.propTypes = {}, g.defaultProps = {
        ...
        onExiting: E,
        onExited: E
      }, g.UNMOUNTED = d, g.EXITED = m, g.ENTERING = v, g.ENTERED = y, g.EXITING = h;
      var b = function(e, t) {
        ...
        x = function(e) {
          ...
          return n.addClass = function(e, t, n) {
            ...
            "appear" === t && "done" === n && i && (o += " " + i), "active" === n && e && f(e), o && (this.appliedClasses[t][n] = o, r = o, e && r && r.split(" ").forEach(function(t) {
              var n, r;
