  ...
  [2567], {
    22567: function(e, t, n) {
      ...
      function s(e, t) {
        ...
        for (let r in c) r in o ? r in e && !(r in n) && (n[r] = o[r]) : r in t ? n[r] = t[r] : r in e && (n[r] = e[r]);
        return n
      }
      ...
      function d(e) {
        if ("object" != typeof e || null === e || "string" != typeof e.prefix || !e.icons || "object" != typeof e.icons || !p(e, u)) return null;
        let t = e.icons;
        for (let e in t) {
          let n = t[e];
        ...
        for (let e in n) {
          let r = n[e],
            i = r.parent;
          if (!e || "string" != typeof i || !t[i] && !n[i] || !p(r, c)) return null
        }
        return e
      }
      let h = /^[a-z0-9]+(-[a-z0-9]+)*$/,
      ...
      let z = Object.create(null),
        ...
        P = [];
      for (; R.length > 0;) 1 === R.length ? P.push(R.shift()) : Math.random() > .5 ? P.push(R.shift()) : P.push(R.pop());
      z[""] = N({
        ...
        return {
          query: function(e, i, l) {
            let o = function(e, t, n, r) {
              ...
              function g() {
                "pending" === s && (s = "aborted"), h(), p.forEach(e => {
              ...
              return "function" == typeof r && d.push(r), setTimeout(function r() {
                  if ("pending" !== s) return;
                  h();
                  let o = i.shift();
                  if (void 0 === o) {
                  ...
                  let a = {
                    ...
                    callback: (t, n) => {
                      ! function(t, n, o) {
                        ...
                        s = "completed", d.forEach(e => {
                          e(o)
                        })
                      }(a, t, n)
                    }
                  };
                  p.push(a), f++, u = setTimeout(r, e.rotate), n(o, t, a.callback)
                }),
                function() {
                  return {
                    startTime: c,
      ...
      function Q(e, t, n) {
        ...
        r(), e.iconsLoaderFlag || (e.iconsLoaderFlag = !0, setTimeout(() => {
          e.iconsLoaderFlag = !1, e.pendingCallbacksFlag || (e.pendingCallbacksFlag = !0, setTimeout(() => {
            ...
            t.forEach(t => {
              ...
              l.pending = l.pending.filter(t => {
                ...
                return !1
              }), l.pending.length !== o && (n || $([e], t.id), t.callback(l.loaded.slice(0), l.missing.slice(0), l.pending.slice(0), t.abort))
            })
          }))
        }))
      }
      ...
      let W = (e, t) => {
            ...
            l = function(e) {
              ...
              return e.forEach(e => {
                ...
                let i = e.provider,
                  ...
                  c = a[l] || (a[l] = y(i, l));
                (o in c.icons ? t.loaded : "" === l || c.missing.has(o) ? t.missing : t.pending).push({
                  provider: i,
                  prefix: l,
                  name: o
                })
          ...
          return l.pending.forEach(e => {
            ...
            let {
              ...
              prefix: n,
              name: r
            } = e, i = y(t, n), l = i.pendingIcons || (i.pendingIcons = new Set);
            l.has(r) || (l.add(r), o[t][n].push(r))
          }), a.forEach(e => {
            let t = o[e.provider][e.prefix];
            t.length && (e.iconsToLoad ? e.iconsToLoad = e.iconsToLoad.concat(t).sort() : e.iconsToLoad = t, e.iconsQueueFlag || (e.iconsQueueFlag = !0, setTimeout(() => {
              e.iconsQueueFlag = !1;
              let {
                provider: t,
                prefix: n
      ...
      let ei = (e, t, n) => {
        let l = t.inline ? en : G,
          o = function(e, t) {
            ...
            for (let e in t) {
              let r = t[e],
                i = typeof r;
              e in j ? (null === r || r && ("string" === i || "number" === i)) && (n[e] = r) : i === typeof n[e] && (n[e] = "rotate" === e ? r % 4 : r)
            }
            return n
          }(l, t),
          c = t.mode || "svg",
        ...
        for (let e in t) {
          ...
          if (void 0 !== n) switch (e) {
            ...
            case "color":
              ...
              break;
            case "rotate":
              "string" == typeof n ? o[e] = function(e, t = 0) {
                let n = e.replace(/^-?[0-9.]*/, "");
        ...
        let p = function(e, t) {
            ...
            [i, l].forEach(e => {
              ...
              switch (r ? i ? l += 2 : (n.push("translate(" + (o.width + o.left).toString() + " " + (0 - o.top).toString() + ")"), n.push("scale(-1 1)"), o.top = o.left = 0) : i && (n.push("translate(" + (0 - o.left).toString() + " " + (o.height + o.top).toString() + ")"), n.push("scale(1 -1)"), o.top = o.left = 0), l < 0 && (l -= 4 * Math.floor(l / 4)), l %= 4) {
                case 1:
                  n.unshift("rotate(90 " + (t = o.height / 2 + o.top).toString() + " " + t.toString() + ")");
                  break;
                case 2:
                  n.unshift("rotate(180 " + (o.width / 2 + o.left).toString() + " " + (o.height / 2 + o.top).toString() + ")");
                  break;
                case 3:
                  n.unshift("rotate(-90 " + (t = o.width / 2 + o.left).toString() + " " + t.toString() + ")")
              }
              l % 2 == 1 && (o.left !== o.top && (t = o.left, o.left = o.top, o.top = t), o.width !== o.height && (t = o.width, o.width = o.height, o.height = t)), n.length && (c = function(e, t, n) {
                var r, i;
                let l = function(e, t = "defs") {
                  ...
                  for (; r >= 0;) {
                    ...
                    let o = e.indexOf(">", l);
                    if (-1 === o) break;
                    n += e.slice(i + 1, l).trim(), e = e.slice(0, r).trim() + e.slice(o + 1)
                  }
                  return {
                    defs: n,
                    content: e
                ...
                return r = l.defs, i = t + l.content + n, r ? "<defs>" + r + "</defs>" + i : i
            ...
            let s = l.width,
              ...
              u = o.width,
              p = o.height;
            null === s ? n = F(r = null === f ? "1em" : "auto" === f ? p : f, u / p) : (n = "auto" === s ? u : s, r = null === f ? F(n, p / u) : "auto" === f ? p : f);
            let d = {},
              h = (e, t) => {
                T(t) || (d[e] = t.toString())
              };
        ...
        if (o.inline && (s.verticalAlign = "-0.125em"), "svg" === c) {
          ...
          return "string" == typeof n && (n = n.replace(/-/g, "_")), u.dangerouslySetInnerHTML = {
            __html: (h = function(e, t = C) {
              ...
              return r.forEach(n => {
                let r = "function" == typeof t ? t(n) : t + (L++).toString(),
                  l = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
                e = e.replace(RegExp('([#;"])(' + l + ')([")]|\\.[a-z])', "g"), "$1" + r + i + "$3")
              }), e = e.replace(RegExp(i, "g"), "")
            }(p.body, n ? () => n + "ID" + e++ : "iconifyReact"), void 0 === r && function() {
              try {
        ...
        let {
          ...
          width: b,
          height: y
        } = e, v = "mask" === c || "bg" !== c && -1 !== m.indexOf("currentColor"), x = function(e, t) {
      ...
      if (w(!0), M[""] = {
          prepare: (e, t, n) => {
            ...
            return n.forEach((n, c) => {
              (a += n.length + 1) >= i && c > 0 && (r.push(o), o = {
                type: l,
                provider: e,
                prefix: t,
                icons: []
              }, a = n.length), o.icons.push(n)
            }), r.push(o), r
          },
          send: (e, t, n) => {
            if (!A) {
          ...
          "object" == typeof t && null !== t && (t instanceof Array ? t : [t]).forEach(e => {
            try {
              ("object" != typeof e || null === e || e instanceof Array || "object" != typeof e.icons || "string" != typeof e.prefix || ! function(e, t) {
                ...
                if ("string" != typeof t && (t = e.provider || ""), x && !t && !e.prefix) {
                  let t = !1;
                  return d(e) && (e.prefix = "", f(e, (e, n) => {
                    (function(e, t) {
                      let n = g(e, !0, x);
                      if (!n) return !1;
                      ...
                      return t ? function(e, t, n) {
                        ...
                        return !1
                      }(r, n.name, t) : (r.missing.add(n.name), !0)
                    })(e, n) && (t = !0)
                  })), t
                }
                let n = e.prefix;
      ...
      function el(e) {
        let [t, n] = (0, i.useState)(!!e.ssr), [r, l] = (0, i.useState)({}), [o, c] = (0, i.useState)(function(t) {
          if (t) {
            let t = e.icon;
        ...
        }(0, i.useEffect)(() => (n(!0), s), []), (0, i.useEffect)(() => {
          t && function t() {
            var n;
            let r = e.icon;
            if ("object" == typeof r) {
            ...
            if (f({
              ...
              } else i && (null === (n = e.onLoad) || void 0 === n || n.call(e, r))
            }
          }()
        }, [e.icon, t]);
        let {
        ...
        return p ? ei({
          ...a,
          ...p
        }, e, u) : e.children ? e.children : e.fallback ? e.fallback : (0, i.createElement)("span", {})
      }
      let eo = (0, i.forwardRef)((e, t) => el({
        ...e,
        _ref: t
      }));
      (0, i.forwardRef)((e, t) => el({
        inline: !0,
        ...e,
        _ref: t
      }))
